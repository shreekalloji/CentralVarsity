...
import com.iprismtech.studentvarsity.ui.activity.HomeActivity;
...
public class MyExceptionHandler implements Thread.UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, final Throwable exception) {
        ...
        intent = PendingIntent.getActivity(myContext, 0, new Intent(myContext, HomeActivity.class), PendingIntent.FLAG_ONE_SHOT);
