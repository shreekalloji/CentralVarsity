...
public interface CreateNewGroupContract {
    ...
    interface IPresenter {
        ...
        void getList(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void createGroup(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
