...
public interface QuestionRightWrongActivityContract {
    ...
    interface IPresenter {
       ...
       // void submit_quiz_answers(Context context, APIResponseCallback apiResponseCallback, String requestBody);
        void right_wrong_attempts(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
