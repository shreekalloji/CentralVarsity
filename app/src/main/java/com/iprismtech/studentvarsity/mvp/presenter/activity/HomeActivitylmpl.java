...
import com.iprismtech.studentvarsity.mvp.contract.activity.HomeActivityContract;
...
public class HomeActivitylmpl  extends BasePresenter implements HomeActivityContract.IPresenter {
    private HomeActivityContract.IView mainContainView;
    private Context context;

    public HomeActivitylmpl(HomeActivityContract.IView mainContainView, Context context) {
