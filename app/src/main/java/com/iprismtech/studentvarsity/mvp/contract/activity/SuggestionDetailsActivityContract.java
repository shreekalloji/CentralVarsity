...
public interface SuggestionDetailsActivityContract {
    ...
    interface IPresenter {
        ...
        void suggestions(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void submit_suggestion(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
