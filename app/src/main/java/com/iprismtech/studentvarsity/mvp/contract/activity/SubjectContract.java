...
public interface SubjectContract {
    ...
    interface IPresenter {
        ...
        void subjects(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void change_subjects(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
    }
