...
public interface ConnectUniversityFrdsContract {
    ...
    interface IPresenter {
        ...
        void get_users_using_university(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
