...
public class VideoDetailActivitylmpl extends BasePresenter implements VideoDetailActivityContract.IPresenter {
    private VideoDetailActivityContract.IView mainContainView;
    private Context context;

    public VideoDetailActivitylmpl(VideoDetailActivityContract.IView mainContainView, Context context) {
    ...
    @Override
    public void view_video(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody) {
        UserApiModel userApiModel = new UserApiModel(context,apiResponseCallback);
        userApiModel.view_video(NetworkConstants.RequestCode.VIEW_VIDEOS,requestBody);
    }
    @Override
