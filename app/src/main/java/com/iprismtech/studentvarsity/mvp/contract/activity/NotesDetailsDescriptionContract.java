...
public interface NotesDetailsDescriptionContract {
    ...
    interface IPresenter {
        ...
        void getNotesDesc(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        ...
        void getDiscussDate(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
