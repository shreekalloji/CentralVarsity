...
public class DiscussActvityImpl extends BasePresenter implements DsicussActvityContract.IPresenter{
    public DiscussActvityImpl(Object view, Context context) {
        super(view, context);
    }
