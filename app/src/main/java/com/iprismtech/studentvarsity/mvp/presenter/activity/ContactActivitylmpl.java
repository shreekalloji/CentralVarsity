...
import com.iprismtech.studentvarsity.mvp.contract.activity.ContactActivityContract;
...
public class ContactActivitylmpl extends BasePresenter implements ContactActivityContract.IPresenter {
    private ContactActivityContract.IView mainContainView;
    private Context context;

    public ContactActivitylmpl(ContactActivityContract.IView mainContainView, Context context) {
