...
public interface ForgotPasswordActivityContract {
    ...
    interface IPresenter {
        ...
        void forgot_password(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void update_password(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
    }
