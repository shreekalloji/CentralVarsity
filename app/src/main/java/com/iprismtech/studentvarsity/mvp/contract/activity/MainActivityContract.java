...
public interface MainActivityContract {
    ...
    interface IPresenter {
        ...
        void complete_registration_process(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void update_user_device_token(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void unseen_notification(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
