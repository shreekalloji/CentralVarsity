...
public interface ConnectFriendRequestSentActivityContract {
    ...
    interface IPresenter {
        ...
        void friend_requests_sent(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
