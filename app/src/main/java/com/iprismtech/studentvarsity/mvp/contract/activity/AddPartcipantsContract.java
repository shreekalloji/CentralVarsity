...
public interface AddPartcipantsContract {
    ...
    interface IPresenter {
        ...
        void getnewParList(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void addParticipants(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
