...
public interface GroupDetailsContract {
    ...
    interface IPresenter {
        ...
        void getGrpDetails(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void remove_participant(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
