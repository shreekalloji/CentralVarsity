...
public interface ConnectMyFriendsActivityContract {
    ...
    interface IPresenter {
        ...
        void my_friends(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
