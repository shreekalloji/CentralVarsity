...
public interface ConnectFriendsActivityContract {
    ...
    interface IPresenter {
        ...
        void get_users_from_contacts(Context context, APIResponseCallback apiResponseCallback, String requestBody);
