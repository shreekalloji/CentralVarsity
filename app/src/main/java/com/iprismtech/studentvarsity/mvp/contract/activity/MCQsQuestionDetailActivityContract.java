...
public interface MCQsQuestionDetailActivityContract {
    ...
    interface IPresenter {
        ...
        void getMCQDesc(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        ...
        void viewAllReplies(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
