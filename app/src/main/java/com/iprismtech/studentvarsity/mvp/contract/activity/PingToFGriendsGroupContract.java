...
public interface PingToFGriendsGroupContract {
    ...
    interface IPresenter {
        ...
        void friendsList(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void submit_ping(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
