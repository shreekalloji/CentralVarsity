...
public interface RegistrationActivityContract {
    ...
    interface IPresenter {
        ...
        void streams(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
        void streams_years(Context context, APIResponseCallback apiResponseCallback, Map<String, String> requestBody);
