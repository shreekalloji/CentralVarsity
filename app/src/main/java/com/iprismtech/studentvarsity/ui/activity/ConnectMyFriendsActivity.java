...
import com.iprismtech.studentvarsity.mvp.presenter.activity.ConnectMyFriendsActivitylmpl;
...
public class ConnectMyFriendsActivity extends BaseAbstractActivity<ConnectMyFriendsActivitylmpl> implements ConnectMyFriendsActivityContract.IView, View.OnClickListener, APIResponseCallback {
    ...
    protected View getView() {
        View view = null;
        view = getLayoutInflater().inflate(R.layout.activity_connect_my_friends, null);
        return view;
    }

    @Override
    public void setPresenter() {
        presenter = new ConnectMyFriendsActivitylmpl(this, this);
    }
    ...
    protected void initializeViews() {
        ...
        userSession = new UserSession(ConnectMyFriendsActivity.this);
...
//                }
            ...
            presenter.my_friends(ConnectMyFriendsActivity.this, apiResponseCallback, requestBody);
        }
        ...
        try {
            ...
            if (jsonObject.optString("status_code").equalsIgnoreCase("5000")) {
                ...
                if (status) {
                    ...
                    LinearLayoutManager mLayoutManager = new LinearLayoutManager(ConnectMyFriendsActivity.this);
                    ...
                    adapter = new FriendsAdapter(arrayList, ConnectMyFriendsActivity.this);
