...
public class SubReplyAdapter extends RecyclerView.Adapter<SubReplyAdapter.ViewHolder> {
    private Context context;
    private List<AllCommentsPojo.ResponseBean.CommentRepliesBean> comment_replies;

//    public SubReplyAdapter(Context context, List<NotesDescriptionViewPojo.CommentsBean.CommentRepliesBean> comment_replies) {
//        this.context = context;
//        this.comment_replies = comment_replies;
//    }

    public SubReplyAdapter(Context context, List<AllCommentsPojo.ResponseBean.CommentRepliesBean> comment_replies) {
        this.context = context;
        this.comment_replies = comment_replies;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        ...
        Picasso.with(context)
                .load(NetworkConstants.URL.Imagepath_URL + comment_replies.get(i).getProfile_pic())
