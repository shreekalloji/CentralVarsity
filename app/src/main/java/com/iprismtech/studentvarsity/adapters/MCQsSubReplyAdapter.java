...
public class MCQsSubReplyAdapter extends RecyclerView.Adapter<MCQsSubReplyAdapter.ViewHolder> {
    private Context context;
    private List<MCQsDetailsPojo.CommentsBean.CommentRepliesBean> comment_replies;

    public MCQsSubReplyAdapter(Context context, List<MCQsDetailsPojo.CommentsBean.CommentRepliesBean> comment_replies) {
