...
public class VideosAdapter extends RecyclerView.Adapter<VideosAdapter.YearAdapterView> {
    ...
    public VideosAdapter(List<VideosListPOJO.ResponseBean> cartPojo, Activity context, VideoCallBack videoCallBack) {
