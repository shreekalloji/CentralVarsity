...
public class ActvittySubReplyAdapter extends RecyclerView.Adapter<ActvittySubReplyAdapter.ViewHolder> {
    private Context context;
    private List<ActivityDetailsPojo.CommentsBean.CommentRepliesBean> comment_replies;

    public ActvittySubReplyAdapter(Context context, List<ActivityDetailsPojo.CommentsBean.CommentRepliesBean> comment_replies) {
