...
public class WrongAttemptAdapter extends RecyclerView.Adapter<WrongAttemptAdapter.YearAdapterView> {
    ...
    public WrongAttemptAdapter(RightWrongPOJO cartPojo, Context context) {
    ...
    public void onBindViewHolder(YearAdapterView holder, int position) {
        ...
        holder.tv_question.setText(cartPojo.getWrong_answers().get(position).getQuestion());
        holder.tv_questionnoof.setText("Q.no."+String.valueOf(position + 1));


        holder.tv_opt1.setText(cartPojo.getWrong_answers().get(position).getOptions().get(0).getOptions());
        holder.tv_opt2.setText(cartPojo.getWrong_answers().get(position).getOptions().get(1).getOptions());
        holder.tv_opt3.setText(cartPojo.getWrong_answers().get(position).getOptions().get(2).getOptions());
        holder.tv_opt4.setText(cartPojo.getWrong_answers().get(position).getOptions().get(3).getOptions());


        if (cartPojo.getWrong_answers().get(position).getCorrect_answer().equalsIgnoreCase("A")) {
        ...
        if (cartPojo.getWrong_answers().get(position).getCorrect_answer().equalsIgnoreCase("B")) {
        ...
        if (cartPojo.getWrong_answers().get(position).getCorrect_answer().equalsIgnoreCase("C")) {
        ...
        if (cartPojo.getWrong_answers().get(position).getCorrect_answer().equalsIgnoreCase("D")) {
        ...
        if (cartPojo.getWrong_answers().get(position).getAnswer().equalsIgnoreCase("A")) {
            holder.ll_opt1.setBackground(context.getResources().getDrawable(R.drawable.wrong_background));
        }
       else if (cartPojo.getWrong_answers().get(position).getAnswer().equalsIgnoreCase("B")) {
            holder.ll_opt2.setBackground(context.getResources().getDrawable(R.drawable.wrong_background));
        }
        else  if (cartPojo.getWrong_answers().get(position).getAnswer().equalsIgnoreCase("C")) {
            holder.ll_opt3.setBackground(context.getResources().getDrawable(R.drawable.wrong_background));
        }
        else if (cartPojo.getWrong_answers().get(position).getAnswer().equalsIgnoreCase("D")) {
    ...
    public int getItemCount() {
        return cartPojo.getWrong_answers().size();
    }
